...
func menu_show():
	...
	var text_menu = "[center][img]res://addons/angelica/images/32/0000.png[/img] "
	bbcode_text = text_menu
	for i in menu_bottom:
		var show_big = i
		text_menu += i
		show_big = text_menu+(show_big.replace("16/","32/"))
		bbcode_text = show_big + "[img]res://addons/angelica/images/32/0000.png[/img]"
		reflex.bbcode_text = show_big + "[img]res://addons/angelica/images/32/0000.png[/img]"
		yield(get_tree().create_timer(0.06), "timeout")
		bbcode_text = text_menu + "[img]res://addons/angelica/images/32/0000.png[/img]"
		reflex.bbcode_text = text_menu + "[img]res://addons/angelica/images/32/0000.png[/img]"

func construct_menu():
	var text_menu = "[center]"
	for i in menu_bottom:
		text_menu += i
	bbcode_text = text_menu + "[img]res://addons/angelica/images/32/0000.png[/img][/center]"
	reflex.bbcode_text = text_menu + "[img]res://addons/angelica/images/32/0000.png[/img][/center]"
