...
onready var paint_control = _parent.get_node(@"../../../GDPaint2D/PaintControl")
...
func _ready():
	...
	$ButtonNone.connect("pressed", self, "button_pressed", ["mode_none"])
...
func _physics_process(_delta):
	...
	fps_count = "\nFPS: " + str(fps_count)
	label_stats.text = "Objects: " + String(paint_control.brush_data_list.size())+fps_count
...
#		save_dialog.popup_centered()
	...
	if tool_name != null:
		label_tools.text = "Tool: " + tool_name
	if shape_name != null:
