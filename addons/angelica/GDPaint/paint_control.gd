...
var is_mouse_in_drawing_area = true
...
var brush_mode = BrushModes.NONE
var brush_size = 4
var brush_color = "#f1adef"
...
func _physics_process(delta):
	if brush_mode != BrushModes.NONE:
		if brush_mode == BrushModes.REWIND:
			if brush_data_list != null:
