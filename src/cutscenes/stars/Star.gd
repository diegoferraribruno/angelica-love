...
var bg_color = [Color(3,2,0.7,1), Color(0.8,0.9,4,1), Color(3,4,5,1), Color(2,4,3,1), Color(4,3,5,1) ]
...
func _draw():
		...
		draw_circle(Vector2(0,0), int(rand_range(0.8,5)), startglow)
